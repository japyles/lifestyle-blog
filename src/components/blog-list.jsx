...
//     setLoading(true)
//     try {
//       const res = await fetch(`/api/posts?page=${currentPage}&search=${search}`)
//       const data = await res.json()
//       if (data.success) {
//         setPosts(data.data)
//         setTotalPages(Math.ceil(data.pagination.total / 10))
...
//       ) : (
//         posts.map((post) => (
//           <article key={post._id} className="grid md:grid-cols-2 gap-8 items-center">
//             <div className="relative aspect-square md:aspect-[4/3]">
//               {post.imageUrl ? (
//                 <Image
//                   src={post.imageUrl}
...
//             </span>
//             <h2
//               className='font-dm-serif text-[#1b1b1b] text-4xl'
...
//             </p>
//             <div
//               className='text-[#735126] leading-relaxed'
