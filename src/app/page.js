...
//           />
//           <div className='absolute inset-0 bg-black/20' />
//           <div className='absolute inset-0 flex items-center justify-center text-center text-[seashell] p-4'>
//             <h1 className='font-permanent-marker flex justify-center text-2xl lg:text-3xl 2xl:text-6xl max-w-3xl text-[seashell] uppercase tracking-widest whitespace-nowrap'>
//               Leilani&#39;s Lifestyle Blog
//             </h1>
//           </div>
//         </div>
...
//           />
//           <div className='absolute inset-0 bg-black/20' />
//           <div className='absolute inset-0 flex flex-col items-center justify-center text-center text-[seashell] p-4'>
//             <h1 className='font-permanent-marker text-[17px] p-2 md:text-8xl max-w-3xl mb-4 text-[seashell] uppercase tracking-widest'>
//               Leilani&#39;s Lifestyle Blog
//             </h1>
//           </div>
//         </div>
